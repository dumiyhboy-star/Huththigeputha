...
const BOT_NAME_FANCY = 'SAMURAI XMD';
...
const config = {
  ...
  PREFIX: '.',
  MAX_RETRIES: 3,
  GROUP_INVITE_LINK: 'https://chat.whatsapp.com/Eri7DbHdMNW83A6EEeiTMu',
  RCD_IMAGE_PATH: 'https://i.ibb.co/8L0XDHPY/IMG-20260130-WA0036.jpg',
  NEWSLETTER_JID: '120363406870482392@newsletter',
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94728567184',
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7VAdMA89MnKwKXN92W',
  BOT_NAME: 'KAVIYA MD MINI BOT',
  BOT_VERSION: 'v1.0.0',
  OWNER_NAME: 'KAVIYA',
  IMAGE_PATH: 'https://i.ibb.co/8L0XDHPY/IMG-20260130-WA0036.jpg',
  BOT_FOOTER: 'KAVIYA </>',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/8L0XDHPY/IMG-20260130-WA0036.jpg' }
};
...
case 'getpp': {
    try {
        ...
        try {
            ...
            ppUrl = "https://i.ibb.co/8L0XDHPY/IMG-20260130-WA0036.jpg"; // default dp
        }
...
case 'downlord': {
  ...
  try {
    let userCfg = {};
    try { if (number && typeof loadUserConfigFromMongo === 'function') userCfg = await loadUserConfigFromMongo((number || '').replace(/[^0-9]/g, '')) || {}; } catch(e){ userCfg = {}; }
    const title = userCfg.botName || '𝐒𝐀𝐌𝐔𝐑𝐀𝐈 MINI';
